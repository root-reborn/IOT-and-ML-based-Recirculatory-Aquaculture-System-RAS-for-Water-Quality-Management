...
void loop() {   // Put main code here, to run repeatedly
  ...
  phValue = phValue - 1.7;  //Our ph sensor is always giving 1.7 units extra when put in fresh water which should ideally yield 7,so we subtracted this extra value
  ...
  Serial.print(voltage);  // print out the value of analog voltage read by the turbidy sensor
  Serial.println("V");
  delay(1000);
